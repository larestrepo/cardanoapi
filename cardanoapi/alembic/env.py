...
def run_migrations_offline() -> None:
    ...
    url = config.get_main_option('sqlalchemy.url', 'postgresql://cardanodatos:cardanodatos@localhost:5962/cardanodatos')
    context.configure(
        url=url,
    ...
    # params = myconfig(config_path, section='postgresql')  # type: ignore
